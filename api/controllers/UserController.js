...
module.exports = {
  ...
  sendSMS: function(req, res) {
    if (req.body && req.body.mobile && req.body.mobile.toString().length == 10) {
      ...
      sails.request.get({
        url: "http://esms.mytechnologies.co.in/api/smsapi.aspx?username=gadaharia&password=vikasvira&to=" + req.body.mobile + "&from=TMMBLD&message=Your One Time Password for TMM App is " + otp
